            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-muted/50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-primary">$809,397</p>
                ...
                <div className="bg-muted/50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-muted-foreground">$658,712</p>
                  <p className="text-sm text-muted-foreground">Thousands USD</p>
                </div>
              </div>
              ...
              <div className="bg-corporate-blue-light p-4 rounded-lg">
                ...
                <p className="text-foreground">3j,11</p>
              </div>
              ...
              <div className="prose max-w-none">
                ...
                <div className="bg-muted/30 p-6 rounded-lg min-h-[200px]">
                  <p className="text-muted-foreground italic">
                    Content area for detailed analysis and description of Inventories, Net.
                  </p>
                </div>
              </div>
            </div>
