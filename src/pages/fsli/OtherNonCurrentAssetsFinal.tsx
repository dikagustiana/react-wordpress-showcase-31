...
const OtherNonCurrentAssetsFinal = () => {
  const breadcrumbItems = [
    { label: 'Home', path: '/' },
    { label: 'Accounting', path: '/accounting' },
    { label: 'FSLI', path: '/accounting/fsli' },
    { label: 'Other Non-Current Assets (Final)' }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="bg-card rounded-lg p-8 shadow-sm border">
            <h1 className="text-3xl font-bold text-foreground mb-6">
              Other Non-Current Assets (Final)
            </h1>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-muted/50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-primary">$533,865</p>
                ...
                <div className="bg-muted/50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-muted-foreground">$455,380</p>
                  <p className="text-sm text-muted-foreground">Thousands USD</p>
                </div>
              </div>
              ...
              <div className="bg-corporate-blue-light p-4 rounded-lg">
                ...
                <p className="text-foreground">15b</p>
              </div>
              ...
              <div className="prose max-w-none">
                ...
                <div className="bg-muted/30 p-6 rounded-lg min-h-[200px]">
                  <p className="text-muted-foreground italic">
                    Content area for detailed analysis and description of Other Non-Current Assets (Final).
                  </p>
                </div>
              </div>
            </div>
...
export default OtherNonCurrentAssetsFinal;