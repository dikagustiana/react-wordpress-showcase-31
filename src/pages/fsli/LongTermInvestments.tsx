            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-muted/50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-primary">$1,109,172</p>
                ...
                <div className="bg-muted/50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-muted-foreground">$1,602,821</p>
                  <p className="text-sm text-muted-foreground">Thousands USD</p>
                </div>
              </div>
              ...
              <div className="prose max-w-none">
                ...
                <div className="bg-muted/30 p-6 rounded-lg min-h-[200px]">
                  <p className="text-muted-foreground italic">
                    Content area for detailed analysis and description of Long-Term Investments.
                  </p>
                </div>
              </div>
            </div>
