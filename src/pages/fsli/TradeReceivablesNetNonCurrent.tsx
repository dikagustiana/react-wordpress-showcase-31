...
const TradeReceivablesNetNonCurrent = () => {
  const breadcrumbItems = [
    { label: 'Home', path: '/' },
    { label: 'Accounting', path: '/accounting' },
    { label: 'FSLI', path: '/accounting/fsli' },
    { label: 'Trade Receivables, Net (Non-Current)' }
  ];
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-muted/50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-primary">$544,278</p>
                ...
                <div className="bg-muted/50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-muted-foreground">$522,121</p>
                  <p className="text-sm text-muted-foreground">Thousands USD</p>
                </div>
              </div>
              ...
              <div className="bg-corporate-blue-light p-4 rounded-lg">
                ...
                <p className="text-foreground">3i,12</p>
              </div>
              ...
              <div className="prose max-w-none">
                ...
                <div className="bg-muted/30 p-6 rounded-lg min-h-[200px]">
                  <p className="text-muted-foreground italic">
                    Content area for detailed analysis and description of Trade Receivables, Net (Non-Current).
                  </p>
                </div>
              </div>
            </div>
...
export default TradeReceivablesNetNonCurrent;